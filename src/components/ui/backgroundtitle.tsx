...
const BackgroundTitle = (props: any) => {
  ...
  return (
    <div
      className={`${containerClassName} relative z-[5] p-[2px] flex justify-center items-center rounded-[1rem] border-[1px] border-black bg-[linear-gradient(to_top,rgba(255,255,255,0.2),gray,white,gray,rgba(255,255,255,0.2))]`}
      {...rest}
    >
