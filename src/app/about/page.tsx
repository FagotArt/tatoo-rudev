  ...
  return (
    <div>
      ...
      className="mt-[-60px] pt-[100px]">
        <div
            className="font-['Helvetica']  max-w-[min(90%,600px)] mx-auto mb-[2rem]"
        >
        ...
        <div
            className="text-[1.5rem] text-center font-bold mb-[1rem]"
        >
            Want to send us a message?
        </div>
        <Divider className="!mb-[1rem] w-[20rem]"/>
        <Input label="Name" containerClassName="md:min-w-[400px] mb-[1rem] mx-auto"/>
        <TextArea 
            containerClassName="min-w-[350px] md:min-w-[400px] mb-[1rem] mx-auto"
            placeHolder="Message..."
            inputClassName="h-[200px]"
        />
        <Button containerClassName="mx-auto" className="mx-auto px-[4rem]">Submit</Button>
      </BackgroundSection>
      <div
        className="mx-[10px] "
      >
